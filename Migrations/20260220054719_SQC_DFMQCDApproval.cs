...
{
    /// <inheritdoc />
    public partial class SQC_DFMQCDApproval : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "sqc_dfm_qcd_approval",
                columns: table => new
                {
                    ...
                    NeedNoNeedQcdMtg = table.Column<string>(type: "text", nullable: true),
                    ApprovalLeadTime = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sqc_dfm_qcd_approval", x => x.Id);
                });
        }
