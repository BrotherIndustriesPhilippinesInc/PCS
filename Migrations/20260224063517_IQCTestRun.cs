...
{
    /// <inheritdoc />
    public partial class IQCTestRun : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResultEmailDatetoSupplier = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ResultPassedFailed = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_iqc_test_run", x => x.Id);
                });
        }
