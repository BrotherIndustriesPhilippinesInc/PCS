...
{
    /// <inheritdoc />
    public partial class ToolingPOIssuance2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetIssueDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ActualIssueDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MP2ToolingPoIssuance", x => x.Id);
                });
        }
