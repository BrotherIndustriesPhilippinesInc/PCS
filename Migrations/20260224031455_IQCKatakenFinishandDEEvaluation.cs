...
{
    /// <inheritdoc />
    public partial class IQCKatakenFinishandDEEvaluation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_de_evaluation", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "iqc_kataken_finish",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_iqc_kataken_finish", x => x.Id);
                });
        }
