            ...
            modelBuilder.Entity("PartsControlSystem.Models.Other4MProcessMapping", b =>
                {
                    ...
                    b.ToTable("Other4MProcessMappings", (string)null);
            ...
            modelBuilder.Entity("PartsControlSystem.Models.ViewOther4MMonitoring", b =>
                {
                    ...
                    b.Property<DateTime?>("de_parts_received_date")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("delivery_po_request_date")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("delivery_po_target_date")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("ee_actual_finished_date")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("ee_parts_received_date")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("implementation_date")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("itf_actual_finished_date")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("kataken_request_target")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("kataken_requested_date")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("kataken_sample_submission_date")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("qa_actual_finished_date")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("qa_parts_received_date")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("test_run_actual_received_date")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("test_run_meeting_actual")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("test_run_meeting_target")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("test_run_po_request_date")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToView("view_other4m_monitoring", "public");
                });
