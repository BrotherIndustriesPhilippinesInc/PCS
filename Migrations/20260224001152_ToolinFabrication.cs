...
{
    /// <inheritdoc />
    public partial class ToolinFabrication : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "mp2_tooling_fabrication",
                columns: table => new
                {
                    ...
                    FabricationLeadTime = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mp2_tooling_fabrication", x => x.Id);
                });
        }
