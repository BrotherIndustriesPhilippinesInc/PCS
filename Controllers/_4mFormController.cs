...
namespace PartsControlSystem.Controllers
{
    public class _4mFormController : Controller
    {
        ...
        //            _env.WebRootPath,
        //            firstForm.AttachmentPath.TrimStart('/')
        //        );
        ...
        //        // ================= IF FINAL APPROVAL, RETURN SUCCESS =================
        //        if (isFinalApproval)
        //        {
        //            return Json(new
        //            {
        //                success = true,
        //                message = $"All {formsToUpdate.Count} form(s) with control number {firstForm.ControlNumber} have been fully approved."
        //            });
        //        }
        ...
        //            .Where(u =>
        //                u.ApproverRole == nextApproverRole &&
        //                !string.IsNullOrEmpty(u.Email))
        //            .Select(u => u.Email)
        //            .ToListAsync();
        ...
        //        // Build table rows for ALL forms with same control number
        //        var tableRows = string.Join("", formsToUpdate.Select(form => $@"
        //        <tr>
        //            <td style='text-align:center;'>{form.CompanyName}</td>
        //            <td style='text-align:center;'>
        ...
        //        <p>
        //            A <strong>4M Manufacturing Process Change Request</strong>
        ...
        //        {
        //            success = true,
        //            message = $"All {formsToUpdate.Count} form(s) with control number {firstForm.ControlNumber} successfully sent for {emailSubjectSuffix}."
        //        });
        //    }
        //    catch (Exception ex)
        //    {
